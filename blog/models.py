...
class Article(models.Model):
    ...
    en_title = models.CharField(max_length=100,unique=True,verbose_name=u'英文标题')
...
class Message(models.Model):
    ...
    message = models.TextField(verbose_name=u'留言内容')
    status = models.IntegerField(default=0,choices=MSTATUS.items(),verbose_name='状态')
    create_time = models.DateTimeField(u'创建时间',auto_now_add=True)
    class Meta:
        verbose_name_plural = verbose_name = u'留言'
        ordering = ['-create_time']
        app_label = string_with_title('jiange_comments',u"留言管理")

class Link(models.Model):
    url = models.CharField(max_length=100,verbose_name=u'友情链接')
    name = models.CharField(max_length=100,verbose_name=u'站名')
    class Meta:
        verbose_name_plural = verbose_name = u'友情链接'
        app_label = string_with_title('blog',u"博客管理")

#class Visitor(models.Model):
#    ip = models.CharField(max_length=100,verbose_name=u'访客ip')
#    visit_time = models.DateTimeField(u'访问时间',auto_now_add=True)
#    class Meta:
#        verbose_name_plural = verbose_name = u'访客信息'
#        app_label = string_with_title('blog',u"博客管理")
